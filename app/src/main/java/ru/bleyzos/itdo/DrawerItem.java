...
final class DrawerItem {
    ...
    private DrawerItem(String key, int title, int icon, int kind, String arg, boolean staffOnly) {
        this.key = key;
        this.title = title;
        this.icon = icon;
        this.kind = kind;
    ...
    static final List<DrawerItem> ALL = Collections.unmodifiableList(Arrays.asList(
            ...
            page("notifications", R.string.nav_notifications, R.drawable.ic_notifications),
            ...
            page("clips", R.string.nav_clips, R.drawable.ic_clips),
            ...
            url("pixelbattle", R.string.nav_pixelbattle, R.drawable.ic_grid, "/pixelbattle.html", false),

            section(R.string.section_itdo),
            page("nuksta", R.string.nav_pro, R.drawable.ic_star),
            page("wallet", R.string.nav_wallet, R.drawable.ic_wallet),
            js("leaderboard", R.string.nav_leaderboard, R.drawable.ic_trophy, "openLeaderboard()"),
            js("quests", R.string.nav_quests, R.drawable.ic_quests, "openQuests()"),
            url("agent", R.string.nav_agent, R.drawable.ic_agent, "/ai-agent.html", false),

            section(0),
            page("settings", R.string.nav_settings, R.drawable.ic_settings),
            ...
            new DrawerItem("logout", R.string.nav_logout, R.drawable.ic_logout, LOGOUT, null, false)
    ));
